...
public class Input {
	...
	public Input(Controller controller) {
		...
		/*
		 * downMouseButtons.add(1); downMouseButtons.add(2);
		 * downMouseButtons.add(3); downUpMouseButtons.add(2);
		 * downUpMouseButtons.add(3); downKeyCodes.add(KeyEvent.VK_A);
		 * downKeyCodes.add(KeyEvent.VK_B); downKeyCodes.add(KeyEvent.VK_C);
		 * downKeyCodes.add(KeyEvent.VK_D); downKeyCodes.add(KeyEvent.VK_E);
		 * final KeyStroke ks1 = new KeyStroke(); ks1.setModifierCodes(new
		 * Integer[] { }); ks1.setKeyCodes(new Integer[] { KeyEvent.VK_A });
		 * downUpKeyStrokes.add(ks1); final KeyStroke ks2 = new KeyStroke();
		 * ks2.setModifierCodes(new Integer[] { KeyEvent.VK_CONTROL });
		 * ks2.setKeyCodes(new Integer[] { KeyEvent.VK_A, KeyEvent.VK_B });
		 * downUpKeyStrokes.add(ks2); final KeyStroke ks3 = new KeyStroke();
		 * ks3.setModifierCodes(new Integer[] { KeyEvent.VK_SHIFT,
		 * KeyEvent.VK_ALT }); ks3.setKeyCodes(new Integer[] { KeyEvent.VK_A,
		 * KeyEvent.VK_B, KeyEvent.VK_C }); downUpKeyStrokes.add(ks3);
		 */
		/*
		 * Mode defaultMode = profile.getModes().get(0); Mode mode1 = new
		 * Mode("54947df8-0e9e-4471-a2f9-9af509fb5889"); mode1.setDescription(
		 * "View mode"); Mode mode2 = new
		 * Mode("046b6c7f-0b8a-43b9-b35d-6489e6daee91"); mode2.setDescription(
		 * "Mouse mode");
		 * 
		 * List<IAction> xAxisActionsP0 = new ArrayList<>(); AxisToAxisAction
		 * xAxisAction0 = new AxisToAxisAction();
		 ...
		 * List<IAction> xAxisActionsP1 = new ArrayList<>(); AxisToKeyAction
		 * xAxisAction1 = new AxisToKeyAction(); KeyStroke xAxisAction1Keystroke
		 * = new KeyStroke(); xAxisAction1Keystroke.setKeyCodes(new String[] {
		 * "VK_I" }); xAxisAction1.setKeystroke(xAxisAction1Keystroke);
		 * xAxisAction1.setMinAxisValue(0.9f);
		 * xAxisAction1.setMaxAxisValue(1.0f); xAxisAction1.setDownUp(false);
		 ...
		 * AxisToRelativeAxisAction yAxisAction0P0 = new
		 * AxisToRelativeAxisAction();
		 * yAxisAction0P0.setVirtualAxis(VirtualAxis.S0);
		 * yAxisAction0P0.setInvert(false); yAxisAction0P0.setSensitivity(2.0f);
		 * yAxisActionsP0.add(yAxisAction0P0); AxisToButtonAction yAxisAction1P0
		 * = new AxisToButtonAction(); yAxisAction1P0.setButtonId(1);
		 ...
		 * List<IAction> yAxisActionsP2 = new ArrayList<>(); AxisToScrollAction
		 * yAxisAction0P2 = new AxisToScrollAction();
		 * yAxisAction0P2.setClicks(10); yAxisActionsP2.add(yAxisAction0P2);
		 * mode2.getComponentToActionMap().put("y", yAxisActionsP2);
		 * 
		 * List<IAction> rxAxisActionsP0 = new ArrayList<>(); AxisToAxisAction
		 * rxAxisAction0P0 = new AxisToAxisAction();
		 ...
		 * List<IAction> rxAxisActionsP2 = new ArrayList<>(); AxisToCursorAction
		 * rxAxisAction0P2 = new AxisToCursorAction();
		 ...
		 * 
		 * List<IAction> ryAxisActionsP0 = new ArrayList<>(); AxisToAxisAction
		 * ryAxisAction0P0 = new AxisToAxisAction();
		 ...
		 * List<IAction> ryAxisActionsP2 = new ArrayList<>(); AxisToCursorAction
		 * ryAxisAction0P2 = new AxisToCursorAction();
		 ...
		 * List<IAction> xButtonActionsP2 = new ArrayList<>(); ButtonToKeyAction
		 * xButtonAction0P2 = new ButtonToKeyAction(); KeyStroke
		 * xButtonAction0P2Keystroke = new KeyStroke();
		 ...
		 * 
		 * List<IAction> oButtonActions = new ArrayList<>(); ButtonToKeyAction
		 * oButtonAction0 = new ButtonToKeyAction(); KeyStroke
		 * oButtonAction0Keystroke = new KeyStroke();
		 ...
		 * oButtonAction0.setDownUp(true); oButtonActions.add(oButtonAction0);
		 * defaultMode.getComponentToActionMap().put("13", oButtonActions);
		 * 
		 * List<IAction> triangleButtonActionsP2 = new ArrayList<>();
		 * ButtonToScrollAction triangleButtonAction = new
		 * ButtonToScrollAction(); triangleButtonAction.setClicks(1);
		 ...
		 * 
		 * List<IAction> r1ButtonActions = new ArrayList<>(); ButtonToModeAction
		 * r1ButtonAction0 = new ButtonToModeAction();
		 * r1ButtonAction0.setMode(mode1); r1ButtonActions.add(r1ButtonAction0);
		 * profile.getComponentToModeActionMap().put("11", r1ButtonAction0);
		 * 
		 * List<IAction> l1ButtonActions = new ArrayList<>(); ButtonToModeAction
		 * l1ButtonAction0 = new ButtonToModeAction();
		 * l1ButtonAction0.setMode(mode2); l1ButtonAction0.setToggle(true);
		 * l1ButtonActions.add(l1ButtonAction0);
		 * profile.getComponentToModeActionMap().put("10", l1ButtonAction0);
		 * 
		 * profile.getModes().add(mode1); profile.getModes().add(mode2);
		 */
	}
