...
final class AssignmentsComponent extends JScrollPane {
    ...
    AssignmentsComponent(final Main main) {
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("LEFT_TRIGGER"),
                        new Component(ComponentType.AXIS, GLFW.GLFW_GAMEPAD_AXIS_LEFT_TRIGGER)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("RIGHT_TRIGGER"),
                        new Component(ComponentType.AXIS, GLFW.GLFW_GAMEPAD_AXIS_RIGHT_TRIGGER)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("LEFT_BUMPER"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_LEFT_BUMPER)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("GUIDE_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_GUIDE)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("RIGHT_BUMPER"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_RIGHT_BUMPER)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("BACK_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_BACK)),
                constraints);
        ...
        assignmentsPanel.add(
                createComponentButton(
                        main,
                        Main.strings.getString("START_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_START)),
                constraints);
        ...
        assignmentsPanel.add(
                new FourWay(
                        main,
                        Main.strings.getString("Y_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_Y),
                        Main.strings.getString("X_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_X),
                        Main.strings.getString("B_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_B),
                        Main.strings.getString("A_BUTTON"),
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_A)),
                constraints);
        ...
        assignmentsPanel.add(
                new FourWay(
                        main,
                        Main.strings.getString("DPAD_UP"),
                        ...
                        new Component(ComponentType.BUTTON, GLFW.GLFW_GAMEPAD_BUTTON_DPAD_DOWN)),
                constraints);
    ...
    private static JButton createComponentButton(final Main main, final String name, final Component component) {
        ...
        if (component.type() == ComponentType.BUTTON
                && (component.index() == GLFW.GLFW_GAMEPAD_BUTTON_A
                        || component.index() == GLFW.GLFW_GAMEPAD_BUTTON_B
                        || component.index() == GLFW.GLFW_GAMEPAD_BUTTON_X
                        || component.index() == GLFW.GLFW_GAMEPAD_BUTTON_Y
                        || component.index() == GLFW.GLFW_GAMEPAD_BUTTON_BACK
    ...
    private static final class CompoundButton extends CustomButton {
        ...
        private CompoundButton(
                ...
                final CompoundButtonLocation buttonLocation,
                final CompoundButton peer) {
    ...
    private abstract static class CustomButton extends JButton {
        ...
        void beginBackground(final Graphics2D g2d) {
            ...
            final var background = FlatButtonUI.buttonStateColor(
                    this,
                    def ? defaultBackground : getBackground(),
                    null,
        ...
        void beginBorder(final Graphics2D g2d) {
            ...
            final var def = isDefaultButton();
            final var color = FlatButtonUI.buttonStateColor(
                    this,
    ...
    private static final class Stick extends JPanel {
        ...
        private Stick(final Main main, final StickType type) {
            ...
            final var xComponent = new Component(
                    ComponentType.AXIS, left ? GLFW.GLFW_GAMEPAD_AXIS_LEFT_X : GLFW.GLFW_GAMEPAD_AXIS_RIGHT_X);
            final var yComponent = new Component(
                    ComponentType.AXIS, left ? GLFW.GLFW_GAMEPAD_AXIS_LEFT_Y : GLFW.GLFW_GAMEPAD_AXIS_RIGHT_Y);

            final var northernButton =
                    new CompoundButton(main, this, yComponent, CompoundButton.CompoundButtonLocation.North, null);
            add(northernButton);
            final var westernButton =
                    new CompoundButton(main, this, xComponent, CompoundButton.CompoundButtonLocation.West, null);
            add(westernButton);
            add(new CompoundButton(main, this, xComponent, CompoundButton.CompoundButtonLocation.East, westernButton));
            add(new CompoundButton(
                    main, this, yComponent, CompoundButton.CompoundButtonLocation.South, northernButton));
        }
