...
public final class EditActionsDialog extends JDialog {
    ...
    static {
        try (final var scanResult = new ClassGraph()
                .acceptPackages(IAction.class.getPackageName())
                .enableClassInfo()
    ...
    private void init() {
        ...
        actionsPanel.add(
                new JLabel(Main.strings.getString("AVAILABLE_ACTIONS_LABEL")),
        ...
        updateAvailableActions();
        actionsPanel.add(
                new JScrollPane(availableActionsList),
                new GridBagConstraints(
                        0,
                        1,
                        1,
        ...
        actionsPanel.add(
                new JLabel(Main.strings.getString("ASSIGNED_ACTIONS_LABEL")),
                new GridBagConstraints(
                        2,
                        0,
                        1,
        ...
        assignedActionsList.addListSelectionListener(event -> {
            ...
            if (selectedAssignedAction != null) {
                ...
                final var sortedEntires = fieldToActionPropertyMap.entrySet().stream()
        ...
        actionsPanel.add(
                new JScrollPane(assignedActionsList),
                new GridBagConstraints(
                        2,
                        1,
                        1,
